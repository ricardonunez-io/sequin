...
To stream data, you'll create [Streams](/how-sequin-works#streams) for each table you want to stream. Then, you'll consume rows from the Stream using Sequin's [Consume Groups](/how-sequin-works#consumer-groups), [webhooks](/how-sequin-works#webhooks), or [Sync API](/how-sequin-works#sync-api).
...
1. Stream a Postgres table in real-time and with exactly-once processing over an [HTTP interface](/how-sequin-works#consumer-groups).
